...
class MyFlagPage extends StatefulWidget {
  const MyFlagPage({super.key});

  @override
  State<MyFlagPage> createState() => _MyFlagPageState();
}

class _MyFlagPageState extends State<MyFlagPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
